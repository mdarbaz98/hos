						...
						<div class="card">
							<div class="card-body">
								...
								<div id="datatable_wrapper" class="bloglisting dataTables_wrapper dt-bootstrap4 no-footer">
											...
											<table id="datatable" class="table table-bordered dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable_info" style="width: 1292px;">
												<thead>
													<tr role="row">
														...
														<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 307.5px;" aria-label="Position: activate to sort column ascending">Title</th>
												...
												<?php
															...
															$per_page = 10;
															$stmt = $conn->prepare("SELECT * FROM `home_slider` ORDER BY id DESC");
															$stmt->execute();
									...
									$sql = "SELECT * FROM `home_slider` ORDER BY id DESC LIMIT $start,$per_page";
                                    ...
                                    ?>   
													...
													<td class="sorting_1 dtr-control" tabindex="0"><?php echo $i; ?></td>
														...
														<td><?php echo $data['heading_title'] ?></td>
														<td>
															<a href="homeslider_updated.php?id=<?php echo $data['id']; ?>" class="btn btn-success"><i class="fas fa-edit"></i>
														</td>
