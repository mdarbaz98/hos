							...
							<div class="card-body cat_body">
								<form id="update_homeslider">
									...
									<div class="col-lg-6">
										...
										<input type="text" class="form-control add_cat_inputs" id="cat" name="slogan" value="<?php echo $row_cat['heading_slogan'] ?>"> 
                                        </div>
                                        
                                     
                					 <div class="form-group">
                                 <label class="form-label">Description</label>
                                     <textarea class="form-control" rows="6" id="description" name="description"><?php echo $row_cat['heading_para'] ?></textarea>
                                </div>
                                    ...
                                    <div class="mb-3 col-lg-6">
										...
										<input type="text" class="form-control add_cat_inputs" id="title" name="title" value="<?php echo $row_cat['heading_title'] ?>">   </div>
									
										<div class="form-group">
                                        <label for="cat_slug">Add Link</label>
										<input type="text" class="form-control add_cat_inputs" id="cat_title" name="link" value="<?php echo $row_cat['heading_link'] ?>"></div>
                                        ...
                                        <img src="<?php echo $image ?>" alt="<?php echo $image ?>" srcset="" style="width: 120px;">
                                     </div>
						        ...
						        <div class="submit-btns justify-content-end">
										...
										<input type="hidden" name="home_slider_id" value="<?php echo $id ?>">
										<input type="hidden" name="btn" value="updatehome_slider">
										<input type="submit" class="post-btn float-right justify-content-center" value="Updated">
                                     </div>
                                     <?php } } ?>
								</form>
                            </div>
